                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-4">     
                                        ...
                                        <div class="row">
                                            <div class="custom-control custom-radio col-4">
                                                <input type="radio" id="single" name="civilstatus" class="custom-control-input" value="Single">
                        ...
                        <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-control" name="cpassport">
                                            <option value="Australia" name="cpassport" class="category">Australia</option>
                                            <option value="Brunei" name="cpassport" class="category">Brunei</option>
                                            <option value="Cambodia" name="cpassport" class="category">Cambodia</option>
                                            <option value="Canada" name="cpassport" class="category">Canada</option>
                                            <option value="Indonesia" name="cpassport" class="category">Indonesia</option>
                                            <option value="Laos" name="cpassport" class="category">Laos</option>
                                            <option value="Malaysia" name="cpassport" class="category">Malaysia</option>
                                            <option value="Myanmar" name="cpassport" class="category">Myanmar</option>
                                            <option value="New Zealand" name="cpassport" class="category">New Zealand</option>
                                            <option value="Singapore" name="cpassport" class="category">Singapore</option>
                                            <option value="Thailand" name="cpassport" class="category">Thailand</option>
                                            <option value="Vietnam" name="cpassport" class="category">Vietnam</option>
                                         </select>
                                    </div>  
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input class="form-control" type="text" name="pissue" required>
                                    </div>  
                                </div>
                        </div>
                        </div>
