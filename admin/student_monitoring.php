            ...
            <div class="page-title-box">
                                                ...
                                                <div class="">
                                                    ...
                                                    <select class="selectpicker" data-live-search="true" name="name">
                                                        <?php 
                                                            ...
                                                            foreach($rows as $row) { ?>
                                                            <option  style="height:50px" value="<?php echo $row['firstname']." ".$row['middlename']." ".$row['lastname']; ?>"><?php echo $row['firstname']." ".$row['middlename']." ".$row['lastname']; ?></option>
                                                        <?php } ?>
                                                    </select>
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered dt-responsive">
                        ...
                        ?>
                            <tr>
                            <input type="hidden" value="<?php $row['id']; ?>" id="id">
                            ...
                            <td>
                            <a href="update-concern.php" class="btn btn-warning btn-md disablebtn" data-toggle="modal" data-target="#myModal1"><i class="mdi mdi-table-edit"></i></a>
                            </td>
