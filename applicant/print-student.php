<?php 
    ...
    $userid = $_GET['id'];
    $query = $dbh->prepare("SELECT * FROM visa_application WHERE category = 'Student' AND applicantsid = '$userid'");
    $query->execute();
    $rows = $query->fetchAll();
...
?>
    <div style="margin: 0 auto !important; text-align: center !important; padding-top: 50px;">
        ...
        <h4 style="font-family: 'Playfair Display', serif; font-size: 18px;">Student Details </h4>
    </div>
