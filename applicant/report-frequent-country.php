    ...
    <div class="wrapper">
        ...
        <br>
            <div class="form-group row">
                ...
                <div class="col-4">
                    <select class="form-control" id="report-frequent-country">
                ...
                <a target="_blank" href="print-report-frequent-country.php?year=<?php echo $_GET['year']; ?>" class="btn btn-primary center" name="print">Print</a>
            </div>
...
<?php include('charts/frequent-country.php'); ?>
